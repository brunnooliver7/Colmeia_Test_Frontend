...
const Card = props => {
    ...
    const renderDisciplinas = (materia) => {
        ...
        for (let i = 0; i < materia.length; i++) { 
            itens.push(
                <div className="professor-disciplina-itens">
                    {materia[i]}
                </div>
            )
        }
    ...
    const renderCard = () => {
        ...
        return list.map(professor => (
            ...
            <div key={professor._id} className="card">
                ...
                <div className="bottom-container">
                    <div className="bottom-left">
                        <div className="professor-location"><img src="https://aulascolmeia.com.br/img/marker-icon.png"/> {professor.bairro}</div>
                    </div>
